...
import RightClickMenu from "./gmailContextmenu";
  ...
  return (
    <>
      <AccountModal
        ...
        editedUuid={id}
      />
      <ContextMenuTrigger id='gmails'>
        <div
          onClick={(event) =>
            clickedTask(event.currentTarget.getAttribute("id"))
          }
          id={id}
          style={selected}
      ...
      <ContextMenu id='gmails'>
        <MenuItem data={{ test: "item" }} onClick={startSel}>
          Start Selected
        </MenuItem>
        <MenuItem data={{ test: "item" }} onClick={stopSel}>
          Stop Selected
        </MenuItem>
        <MenuItem data={{ test: "item" }} onClick={() => test("v3")}>
          Test v3
        </MenuItem>
        <MenuItem data={{ test: "item" }} onClick={() => test("v2v")}>
          Test v2 visible
        </MenuItem>
        <MenuItem data={{ test: "item" }} onClick={() => test("v2i")}>
          Test v2 invisible
        </MenuItem>
      </ContextMenu>
    </>
