...
const TaskGroup = ({
  ...
  function editGroup(name) {
    handleEdit(uuid, name);
  }
  function deleteGroup() {
    ipcRenderer.send("delete-gmail-group", uuid);
    handleDelete(uuid);
  }
  function isDefault() {
    if (uuid !== "default")
  ...
  return (
    <>
      ...
      <div
        id={uuid}
        className='z-30 flex flex-col justify-between h-36 w-10/12 rounded-lg p-5 relative mb-4'
      ...
      >
        ...
        <button className={pencil} onClick={() => changeVis(true)}>
          <svg
            width='18'
            height='18'
            viewBox='0 0 7 7'
