...
const firstTime = () => {
  fs.stat("modules\\profile maker\\credentials.json", function (err, stats) {
    ...
    if (stats === undefined) {
      ...
      fs.writeFileSync(
        "modules\\profile maker\\credentials.json",
...
const storePrivacyCredentials = (user, pass, name) => {
  credentials = JSON.parse(
    fs.readFileSync("modules\\profile maker\\credentials.json", "utf8")
  );
...
const makePrivacyCards = (user, pass, number) => {
  puppeteer
    ...
    .then(async (browser) => {
      ...
      await page.type(
        "#angular-container > div > div > div.container.-login.ng-scope > form > label.account-field.ng-isolate-scope.-type-email > input",
        user
      );
      await page.type(
        "#angular-container > div > div > div.container.-login.ng-scope > form > label.account-field.ng-isolate-scope.-type-password > input",
        pass
      );
      await page.click(
        "#angular-container > div > div > div.container.-login.ng-scope > form > button"
      );
        ...
        if ((await page.url()) === "https://privacy.com/home") {
          ...
          for (let i = 1; i <= number; i++) {
            ...
            await page.waitForSelector(
              "#home > content > div.home-list-container.ng-isolate-scope > div.home-list.cards.hide-first-card > div.controls._desktop-only > div",
              { visible: true }
            );
            await page.click(
              "#home > content > div.home-list-container.ng-isolate-scope > div.home-list.cards.hide-first-card > div.controls._desktop-only > div"
            ...
            await page.waitForSelector(
              "body > div.modal.ng-scope.ng-isolate-scope.in > div > div > div > div.content > div > div > div.buttons > div.create-button.pill-button.ng-scope",
              { visible: true }
            );
            await page.click(
              "body > div.modal.ng-scope.ng-isolate-scope.in > div > div > div > div.content > div > div > div.buttons > div.create-button.pill-button.ng-scope"
